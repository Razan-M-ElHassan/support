<div class="pagetitle">
	...
	<nav>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">إضافة / تحديث الصلاحيات</li>
		</ol>
	</nav>
</div>
<section class="section dashboard vue_area_div" id="staff_settings">
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
						...
						<!-- Search Section Begin -->
								...
								<div class="col-lg-12">
									<div class="card" v-for="(PG ,CLS) in pages">
										<div class="card-header" :id="'CLS_'+CLS">
											...
											<span> اختر الصفحة الافتراضية </span>
										</div>
							...
							<div class="row">
								<div class="col-sm mb-3 mt-3" v-if="group.ID > 2 || group.ID == ''">
									<button type="submit" id="search" class="btn btn-block btn-success"><i class="bi bi-save"></i> حفــظ مجموعة الصلاحيات</button>
								</div>
