	...
	class configuration extends controller
	{
		...
		*/
		function __construct()
		{
			parent::__construct();
			$this->view->CSS = array();
			$this->view->JS = array('views/configuration/JS/config.js'
									,'public/JS/img.js');
			
			$this->view->curr_page = "configuration";
			$this->view->curr_class = "ADMIN";
		}
		...
		function index()//Main Page ........
		{
			...
			$this->view->render(array('configuration/index'),'admin');
		...
		function del()
		{
			echo json_encode($this->model->del());
		}
